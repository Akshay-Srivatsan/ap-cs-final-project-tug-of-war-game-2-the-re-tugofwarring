...
Description: A high-cost tower which spawns SplashMinions.
**/
public class SplashTower extends Tower
{
	...
	public Minion spawn()
	{
		...
		{
			Minion minion = new SplashMinion(new Point(location), Math.PI/2, getEnemies(), enemyBase, enemyTowers, color);
			return minion;
		}
		return null;
	}
